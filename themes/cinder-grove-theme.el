...
;; The default background is the solid palette color; frame transparency
;; comes from `alpha-background' in config.el, matching how the Neovim
;; setup layered transparency over the theme.
...
(custom-theme-set-faces
 ...
 `(evil-search-highlight-persist-highlight-face ((t (:background
                                                     ,cinder-grove-visual))))
